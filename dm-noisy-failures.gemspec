...
Gem::Specification.new do |s|
  ...
  s.description = 'This library replaces the default behavior of DataMapper by raising exceptions with descriptive error messages whenever DB operations are not successfully completed.'
  s.license     = 'MIT'
